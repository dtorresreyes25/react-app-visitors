...
import { DialogActions, DialogContent, DialogContentText, DialogTitle, withMobileDialog } from '@material-ui/core'
...
const LockScreen = (props) => {
    ...
    const { hasError, handleChange, handleBlur, handleSubmit, formState } = useForm(handleUnlock, schema, null)
    ...
    console.log('state open', openDialog);
    ...
    return (
        ...
        open={openDialog}
        fullScreen={false}>
        <DialogTitle style={{justifyContent:'center', display:'flex', justify:'center'}}><LockIcon style={{width:"20px",height:"20px",marginRight:'5px', marginTop:'5px'}} />Sesion bloqueada por inactividad</DialogTitle>
        <DialogContent>
          ...
          <Grid container spacing={8} alignItems="flex-end">
                   ...
                   <Typography variant="body2">{email}</Typography>
                    ...
                    <Grid container alignItems="flex-end" style={{marginTop:'40px'}}>
                        ...
                        <Grid item md={true} sm={true} xs={true} style={{marginTop: '10px'}}>
                            <TextField 
                            name="password" 
                            ...
                            type="password" 
                             error={hasError('password')}
                              fullWidth
                              helperText={
                                hasError('password') ? formState.errors.email[0] : null
                              }
                            autoFocus="true" />
                        </Grid>
                    </Grid>                
                    <Grid container justify="center" style={{ marginTop: '10px' }}>
                        ...
                        onClick={handleSubmit} >Desbloquear</Button>
                    </Grid>
                    <ToastContainer
                        position="top-center"
                        autoClose={1500}
